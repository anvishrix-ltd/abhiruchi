...
export const metadata: Metadata = {
  ...
  description: "Authentic Hyderabadi and Andhra cuisine served on Castle Street, Sheffield. Order delivery or collection online. Est. 2000.",
  ...
  openGraph: {
    ...
    description: "Authentic Hyderabadi and Andhra cuisine on Castle Street, Sheffield. Order online for delivery or collection.",
    locale: "en_GB",
    type: "website",
  },
  twitter: {
    ...
    description: "Authentic Hyderabadi and Andhra cuisine on Castle Street, Sheffield. Order online.",
  },
