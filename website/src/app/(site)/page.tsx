...
const DEFAULT_CONTENT: ContentMap = {
  ...
  hero_subtext: "From the aromatic biryanis of Hyderabad to the fiery curries of Andhra Pradesh — experience the rich culinary heritage of Telangana, right here on Castle Street, Sheffield.",
